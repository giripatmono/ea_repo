...
**Generated:** 2026-05-18 16:52 Asia/Jakarta  
...
This draft report summarizes the application portfolio using the provided application, technology, data, and risk inventories. The portfolio contains 8 applications: 7 active and 1 proposed. Touchpoint Architecture has the largest application count, followed by Integration Architecture.
...
Primary recommendations are to complete lifecycle data, validate authentication exceptions, define privacy and retention controls for the proposed onboarding application, and establish resilience planning for critical integration dependencies.
...
| Applications using SSO/OIDC, OIDC, or OIDC token validation | 4: Mobile Banking; Internet Banking; API Gateway; Customer Onboarding App |
...
| High | Mobile Banking; Internet Banking; API Gateway; Data Warehouse; Fraud Detection; Customer Onboarding App | High criticality spans customer touchpoints, integration access, analytics, fraud screening, and proposed onboarding. Authentication, data protection, deployment, and lifecycle controls should be validated before material change or expansion. |
